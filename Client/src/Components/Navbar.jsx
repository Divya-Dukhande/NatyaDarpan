...
//           <Link to="/">
//             <img
//               src="/assets/images/NatyaDarpan2.png"
//               alt="Logo"
//               className="h-16 object-contain"
//             />
//           </Link>
...
//         {/* Navigation Links */}
//         <div
//           className={`flex space-x-6 ${isOpen ? 'block' : 'hidden'} lg:flex`}>
//           <ul className="flex flex-col lg:flex-row lg:items-center lg:space-x-6 text-center">
//             <li>
//               <Link
//                 className="text-black hover:text-emerald-400 transition-colors"
//                 to="/"
//               >
//                 Home
//               </Link>
