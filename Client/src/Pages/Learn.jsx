...
//   return (
//     <div className="flex flex-col items-center mt-24 w-full">
//       <h1 className="text-3xl font-bold text-red-600 mb-8 tracking-wider">
//         Learn Bharatanatyam
//       </h1>
...
//             to={`/learn/${category.id}`}
//             key={category.id}
//             className="flex flex-col items-center border border-gray-300 p-4 rounded-lg shadow-md 
//             hover:shadow-xl transition-all duration-300 transform hover:scale-105 bg-white"
//           >
//             <div className="overflow-hidden rounded-lg">
//               <img
//                 src={category.image}
//                 alt={category.name}
//                 className="w-48 h-48 object-contain mb-4 rounded-lg transition-transform duration-300 hover:scale-110"
//               />
//             </div>
//             <span className="text-center text-lg font-semibold text-gray-800 hover:text-red-600 transition-all duration-300">
//               {category.name}
//             </span>
//           </Link>
//         ))}
