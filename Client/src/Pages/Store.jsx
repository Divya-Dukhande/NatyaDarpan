...
import { FaShoppingCart, FaMinus, FaPlus, FaTimes, FaClipboardList } from 'react-icons/fa';
...
const Store = () => {
    ...
    const handleBuyNow = async () => {
        ...
        try {
            // 1. Store address in backend and get addressId
            const addressRes = await client.post('address/add', {
                userId: user._id,
                ...addressForm
            });
            ...
            // 2. Store cart and addressId in localStorage
            localStorage.setItem("checkout_address_id", addressId);
            localStorage.setItem("checkout_cart", JSON.stringify(cart));

            // 3. Redirect to Stripe
            const paymentRes = await client.post('payment/create-checkout-session', {
                userId: user._id,
                cart,
