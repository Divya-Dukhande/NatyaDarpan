...
//         }
//         try {
//             const response = await client.post('order/checkout', { cart, token });
...
//                             <button onClick={handleBuyNow} className="mt-2 bg-green-500 text-white py-2 px-4 rounded-full w-full hover:bg-green-600 transition-colors">
//                                 Buy Now
//                             </button>
//                         </div>
//                     )}
